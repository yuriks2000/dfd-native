...
if((int)$vars['stunning_header_title-font-size'] > 30) {
	...
	$output .= '@media only screen and (max-width: 1280px) and (min-width: 1025px) {'
					. '.page-title-inner:not(.full-height) h1.dfd-page-title {'
						. 'font-size: '.esc_attr($vars['stunning_header_title-font-size'] * .85).'px;'
	...
	$output .= '@media only screen and (max-width: 1024px) and (min-width: 800px) {'
					. '.page-title-inner:not(.full-height) h1.dfd-page-title {'
						. 'font-size: '.esc_attr($vars['stunning_header_title-font-size'] * .7).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
	...
	$output .= '@media only screen and (max-width: 799px) and (min-width: 460px) {'
					. '.page-title-inner:not(.full-height) h1.dfd-page-title {'
						. 'font-size: '.esc_attr($vars['stunning_header_title-font-size'] * .65).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
	...
	$output .= '@media only screen and (max-width: 459px) {'
					. '.page-title-inner:not(.full-height) h1.dfd-page-title {'
						. 'font-size: '.esc_attr($vars['stunning_header_title-font-size'] * .6).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
...
if((int)$vars['stunning_header_subtitle-font-size'] > 16) {
	...
	$output .= '@media only screen and (max-width: 1280px) and (min-width: 1025px) {'
					. '.page-title-inner:not(.full-height) h2.dfd-page-subtitle {'
						. 'font-size: '.esc_attr($vars['stunning_header_subtitle-font-size'] * .85).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
	...
	$output .= '@media only screen and (max-width: 1024px) and (min-width: 800px) {'
					. '.page-title-inner:not(.full-height) h2.dfd-page-subtitle {'
						. 'font-size: '.esc_attr($vars['stunning_header_subtitle-font-size'] * .7).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
	...
	$output .= '@media only screen and (max-width: 799px) and (min-width: 460px) {'
					. '.page-title-inner:not(.full-height) h2.dfd-page-subtitle {'
						. 'font-size: '.esc_attr($vars['stunning_header_subtitle-font-size'] * .65).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
	...
	$output .= '@media only screen and (max-width: 459px) {'
					. '.page-title-inner:not(.full-height) h2.dfd-page-subtitle {'
						. 'font-size: '.esc_attr($vars['stunning_header_subtitle-font-size'] * .6).'px;'
						. 'line-height: '.esc_attr($st_h_responsive_line_height).';'
					. '}'
			. '}';
