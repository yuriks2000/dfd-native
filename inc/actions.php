...
if(!function_exists('dfd_customization_services_notice')) {
	function dfd_customization_services_notice() {
		...
		<div class="notice notice-success is-dismissible">
			...
			<p><strong><a href="http://nativewptheme.net/support/" title="<?php esc_attr_e('Support center','dfd-native') ?>" target="_blank"><?php esc_html_e('Support center', 'dfd-native') ?></a>&nbsp;|&nbsp;<a href="http://dfd.name/services/" title="<?php esc_attr_e('Customization services','dfd-native') ?>" target="_blank"><?php esc_html_e('Customization services', 'dfd-native') ?></a></strong></p>
		</div>
		<?php
	}
}